...
static const Real sRadiusLower = 0.055;
...
static const enum GlbSolVarType GSOL_CURVATURE_TYPE = GSOL_INTERFACE_CURVATURE_GEOMETRIC;
...
/// Post Processing Output Variables
	...
	parseInputHelper.CreateNodalOutputVariables( solutionData, SOL_INTERFACE_CURVATURE_GEOMETRIC, ELEM_VAR, 1, sBSetIds );
...
//        parseInputHelper.CreateNodalOutputVariables   (solutionData, (SolVarType) (SOL_XFEM000+ie), ELEM_VAR, 1, sBSetIds);
	...
	parseInputHelper.CreateBlockSetOutputVariables(solutionData, SOL_MYPID,           1, sBSetIds );
	...
	parseInputHelper.CreateGlobalOutputVariables  (solutionData, GSOL_INTERFACE_CURVATURE_SQUARED, ELEM_VAR, 1, sBSetIds , 0, NULL);
