...
curvature = [pwd, '/', 'GSOL_INTERFACE_CURVATURE_SQUARED'];
...
h =  legend( '$\int_{\phi=0} \Vert \frac{\mathrm{d}\mathbf{n}_{\phi}}{\mathrm{d}s} \Vert^2 \,\mathrm{d}\Gamma$',  '$\frac{2\pi}{r_{c}}$' );
...
h =  legend( '$\vert\int_{\phi=0} \Vert \frac{\mathrm{d}\mathbf{n}_{\phi}}{\mathrm{d}s} \Vert^2 \,\mathrm{d}\Gamma - \frac{2\pi}{r_{c}} \vert$' );
set( h, 'Interpreter', 'Latex', 'FontSize', 20 );
