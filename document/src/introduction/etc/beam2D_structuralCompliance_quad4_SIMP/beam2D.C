    ...
    void ComputeObjectivesAndConstraints(const std::vector <Real> & aCriteriaVals, Real & aObjectiveVal, std::vector <Real> & aConstraintVals)
{
    ...
    /// ----------------------------------------------------------------------------
    aObjectiveVal = 100.0*aCriteriaVals[0] + 0.0*std::pow((aCriteriaVals[2] + aCriteriaVals[3]),0.5);
...
//    UInt numOptScalars = 2;
    ...
    aGrad[0*numCriteria + 0] = 100.;
    aGrad[0*numCriteria + 1] = 0.;
    aGrad[0*numCriteria + 2] = 0.0*0.5/std::sqrt((aCriteriaVals[2] + aCriteriaVals[3]));
    aGrad[0*numCriteria + 3] = 0.0*0.5/std::sqrt((aCriteriaVals[2] + aCriteriaVals[3]));
